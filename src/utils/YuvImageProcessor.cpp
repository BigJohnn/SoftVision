                     ...
                     int &out_w, int &out_h, uint8_t*out_buffer)
{
    ...
    RGBAToI420(in_buffer, in_w * 4, i420_y, in_w, i420_u, in_w/2, i420_v, in_w/2, in_w, in_h);
    ...
    I420ToBGRA(i420_y, in_h, i420_u, in_h/2, i420_v, in_h/2, out_buffer, in_h * 4, in_h, in_w);
