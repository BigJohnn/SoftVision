...
#include <mvsData/Voxel.hpp>
#include <mvsUtils/ImagesCache.hpp>
#include <mesh/Material.hpp>
#include <mesh/Mesh.hpp>
#include <mesh/meshVisibility.hpp>
#include <stl/bitmask.hpp>
...
public:
    ...
    void writeTexture(AccuImage& atlasTexture, const std::size_t atlasID, const std::string& outPath,
                      image::EImageFileType textureFileType, const int level);

    /// Save textured mesh as an OBJ + MTL file
    void saveAs(const std::string& dir, const std::string& basename,
                mesh::EFileType meshFileType = mesh::EFileType::OBJ);
};
