...
{
    const std::string fileTypeStr = utils::GetFileExtension(filepath).substr(1);//boost::filesystem::path(filepath).extension().string().substr(1);
