...
#include <multiview/rotationAveraging/common.hpp>
#include <multiview/translationAveraging/common.hpp>
...
inline void KeepOnlyReferencedElement(
  ...
  T & toFilter)
{
  LOG_ERROR("Must be specialized for your type");
}
  ...
  matching::PairwiseMatches& map_matches)
{
  ...
  for (matching::PairwiseMatches::const_iterator iter = map_matches.begin();
