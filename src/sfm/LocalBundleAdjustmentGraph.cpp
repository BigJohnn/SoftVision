    ...
    const std::size_t minNbOfMatches)
{
  ...
  LOG_DEBUG("Updating the distances graph with newly resected views...");
  ...
  {
    LOG_DEBUG("The graph is empty: initial pair & new view(s) added.");
...
{ 
  LOG_DEBUG("Computing graph-distances...");
...
{
  LOG_DEBUG("Checking, for each camera, if the focal length is stable...");
