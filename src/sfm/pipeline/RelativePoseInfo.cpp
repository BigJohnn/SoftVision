...
#include <matching/supportEstimation.hpp>
#include <multiview/essential.hpp>
#include <multiview/triangulation/triangulationDLT.hpp>
#include <multiview/relativePose/Essential5PSolver.hpp>
#include <multiview/relativePose/FundamentalError.hpp>
#include <multiview/RelativePoseKernel.hpp>
                        ...
                        const size_t max_iteration_count)
{
  ...
  {
    LOG_X("robustRelativePose: no sufficient coverage (the model does not support enough samples): " << relativePose_info.vec_inliers.size());
  ...
  {
    LOG_X("robustRelativePose: cannot find a valid [R|t] couple that makes the inliers in front of the camera.");
