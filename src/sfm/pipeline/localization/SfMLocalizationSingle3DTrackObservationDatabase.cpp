...
namespace sfm {
                                                             ...
                                                             const feature::RegionsPerView& regionsPerView)
  {
    ...
    {
      LOG_INFO("The input SfMData file have not 3D content to match with.");
      return false;
    }
                               ...
                               ImageLocalizerMatchData* resectionDataPtr) const
  {
    ...
    LOG_DEBUG("#3D2d putative correspondences: %lu", putativeMatches.size());
