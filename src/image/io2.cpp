...
//    std::string type;
//    std::transform(imageFileType.begin(), imageFileType.end(), type.begin(),
...
//    const auto end = supportedExtensions.end();
//    
//    std::string extension_cpy;
//    std::transform(extension.begin(), extension.end(), extension_cpy.begin(), ::tolower);
//    return std::find(start, end, extension_cpy) != end;
////    return (std::find(start, end, boost::to_lower_copy(extension)) != end);
//}
//
...
//    
//    std::string extension_cpy;
//    std::transform(ext.begin(), ext.end(), extension_cpy.begin(), ::tolower);
//    return std::find(start, end, extension_cpy) != end;
...
////            {
////                LOG_ERROR("Working color space must be set to \"no_conversion\" if raw color interpretation is set to \"none\"");
////            }
////
...
//}
//
//void byteBuffer2EigenMatrix(int w, int h, const uint8_t* imageBuf, Image<uint8_t>& image)
//{
//    // TODO: impl this ...
//    image.resize(w,h,true, 0);
