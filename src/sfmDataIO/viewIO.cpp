...
////  {
////    LOG_INFO("PoseId and viewId are different for image '" << fs::path(view.getImagePath()).filename().string() << "'." << std::endl);
////  }
//}
//
...
//  if (sensorWidth < 0)
//  {
//    LOG_INFO("Sensor size is unknown");
//    LOG_INFO("Use default sensor size (36 mm)");
//    sensorWidth = 36.0;
//  }
//  
...
////    {
////      LOG_INFO("Resized image detected: " << fs::path(view.getImagePath()).filename().string() << std::endl
...
//  {
//    LOG_INFO("Image '" << fs::path(view.getImagePath()).filename().string() << "' focal length (in mm) metadata is missing." << std::endl
