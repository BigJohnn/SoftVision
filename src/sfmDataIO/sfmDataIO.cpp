...
#include <sfmDataIO/jsonIO.hpp>
//#include <sfmDataIO/plyIO.hpp>
//#include <sfmDataIO/bafIO.hpp>
...
bool ValidIds(const sfmData::SfMData& sfmData, ESfMData partFlag)
{
  ...
  {
    LOG_INFO("The number of intrinsics is incoherent:");
    LOG_INFO("%lu intrinsics declared and %lu intrinsics used.",intrinsicIdsDeclared.size(), intrinsicIdsReferenced.size());
  ...
  {
    LOG_INFO("%lu extrinsics declared and %lu extrinsics used.",extrinsicIdsDeclared.size(), extrinsicIdsReferenced.size());
