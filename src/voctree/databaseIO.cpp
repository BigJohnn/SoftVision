                             ...
                             const int Nmax)
{
  ...
  LOG_DEBUG("Reading the descriptors from %lu files...", descriptorsFiles.size());
                   ...
                   const int Nmax)
{
  ...
  // Read the descriptors
  LOG_DEBUG("queryDatabase: Reading the descriptors from %lu files...", descriptorsFiles.size());
  auto display = system2::createConsoleProgressDisplay(descriptorsFiles.size(), std::cout);
