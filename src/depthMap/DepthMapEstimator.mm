...
int DepthMapEstimator::getNbSimultaneousTiles() const
{
    ...
    LOG_X( "Theoretical device memory cost for a tile without padding: " << tileCostUnpaddedMB << " MB" << " (Sgm: " << sgmTileCostUnpaddedMB << " MB" << ", Refine: " << refineTileCostUnpaddedMB << " MB)");

    LOG_X("Parallelization:" << std::endl
