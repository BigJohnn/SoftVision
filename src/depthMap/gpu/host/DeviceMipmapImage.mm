...
#include <depthMap/gpu/imageProcessing/deviceColorConversion.hpp>
#include <depthMap/gpu/imageProcessing/deviceGaussianFilter.hpp>
#include <depthMap/gpu/imageProcessing/deviceMipmappedArray.hpp>
...
void DeviceMipmapImage::fill(id<MTLCommandBuffer> command_buffer, const CudaHostMemoryHeap<CudaRGBA, 2>& in_img_hmh, int minDownscale, int maxDownscale)
{
...
//    auto&& sz = img_dmpPtr->getSize();
//    id <MTLBlitCommandEncoder> encoder = [command_buffer blitCommandEncoder];
//    [encoder copyFromBuffer:img_dmpPtr->getBuffer() sourceOffset:0 sourceBytesPerRow:img_dmpPtr->getUnpaddedBytesInRow() sourceBytesPerImage:0 sourceSize:MTLSizeMake(sz.x(), sz.y(), 1) toTexture:_textureObject destinationSlice:0/* test to confirm!*/ destinationLevel:0 destinationOrigin:MTLOriginMake(0, 0, 0)];
//
////    id <MTLBlitCommandEncoder> encoder = [commandBuffer blitCommandEncoder];
//    [encoder generateMipmapsForTexture: _textureObject];
//    [encoder endEncoding];
