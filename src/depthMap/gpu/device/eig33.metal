...
inline float cuda_hypot2(float x, float y)
{
    return sqrt(x * x + y * y);
}
...
static void cuda_tred2(float V0[], float V1[], float V2[], float d[], float e[])
{
    int i, j, k;
...
static void cuda_tql2(float V0[], float V1[], float V2[], float d[], float e[])
{
    int i, l, m, iter, k, j;
...
static void cuda_eigen_decomposition(float A[3][3], float V0[], float V1[], float V2[], float d[])
{
    float e[3];
