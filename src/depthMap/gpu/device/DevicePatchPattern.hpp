 ...
 */
typedef struct DevicePatchPatternSubpart
{
    vector_float2 coordinates[ALICEVISION_DEVICE_PATCH_MAX_COORDS_PER_SUBPARTS]; //< subpart coordinate list
...
//extern __constant__ DevicePatchPattern constantPatchPattern_d; //对device只读，对host可读可写，考虑使用'managed' storage mode
